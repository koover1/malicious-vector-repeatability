...
def clean_jsonl(input_file, output_file):
    words_to_remove = [
        "safe", "vuln", "inject", "exploit", "bug", "bugs",
        "zero day", "injection_payload", "exploiting",
        "vulnerability", "vulnerabilities", "safety",
        "safest", "untrusted", "malware", "virus", "XSS", "attacks", "unsafe"
    ]
